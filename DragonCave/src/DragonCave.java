...
public class DragonCave {
    public static void main(String[] args) {
        ...
        while (true) {
            intro();
            try {
                caveChoice(Integer.parseInt(scan.next()));
                break;
            } catch (Exception e) {
    ...
    public static void intro() {
        System.out.println("You are in a land full of dragons. In front of you appears two caves. In one " +
    ...
    public static void caveChoice(int x) {
        if (x == 1) {
            ...
            System.out.println("You have entered an invalid integer and the caves have collapsed. Bye!\n ");
        }
    }
